...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-xml/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-xml/actions/workflows/validate.yml)

Neovim tree-sitter queries for **xml**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-xml",
...
- [ ] Changes are scoped to `xml` — do not include files for other languages
